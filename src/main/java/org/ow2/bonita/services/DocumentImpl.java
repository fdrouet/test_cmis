...
public class DocumentImpl implements Document {
    ...
    public DocumentImpl(final String name, final String folderId, final String author, final Date creationDate,
            Date lastModificationDate, final boolean latestVersion, final boolean majorVersion, final String versionLabel,
            final String versionSeriesId, final String contentFileName, final String contentMimeType, final long contentSize,
            ProcessDefinitionUUID processDefinitionUUID, ProcessInstanceUUID processInstanceUUID) {
        this.name = name;
