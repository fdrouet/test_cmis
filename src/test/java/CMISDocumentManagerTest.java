...
//    assertEquals(author, doc.getAuthor());
  ...
  public void testCreateDocumentInSubFolder() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException{
  ...
  public void testCreateNewVersionOfDocument() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, DocumentNotFoundException {
    byte[] contents = "The doc contents".getBytes();
    String fileName = "testFile.txt";
    String docName = "theDoc";
    String contentMimeType = "plain/text";
...
//    assertEquals(newAuthor, newDoc.getLastModifiedBy());
  ...
  public void testGetVersionsOfDocument() throws DocumentationCreationException, DocumentAlreadyExistsException, FolderAlreadyExistsException {
...
//      return false;
  ...
  public void testSearchDocumentByName() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException{
    Folder folder = manager.createFolder("testSearchDocumentById");
    Document doc1 = manager.createDocument("theDoc1", folder.getId(), "testFile.txt", "plain/text", "The doc contents1".getBytes());
    Document doc2 = manager.createDocument("theDoc2", folder.getId(), "testFile.txt", "plain/text", "The doc contents2".getBytes());
    Document doc3 = manager.createDocument("theDoc3", folder.getId(), "testFile.txt", "plain/text", "The doc contents3".getBytes());
  ...
  public void testSearchWithNoResults() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException{
  ...
  public void testSearchDocumentByCreationDate() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
    Folder folder = manager.createFolder("testSearchDocumentById");
  ...
  public void testSearchDocumentByProcessDefUUID() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
  ...
  public void testSearchDocumentByProcessInstUUID() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
    Folder folder = manager.createFolder("theProcessDefUUID");
    Folder subFolder = manager.createFolder("theProcessInstUUID",folder.getId());
    Document doc1 = manager.createDocument("theDoc1", subFolder.getId(), "testFile.txt", "plain/text",
        "The doc contents1".getBytes());
...
//  public void testSearchDocumentByAuthor() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
...
//  }
  ...
  public void testSearchByProcessDefUUIDAndName() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
  ...
  //Not supported
//  public void testSearchOnAllVersion() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
...
//  }
  ...
  public void testSearchOnLatestVersion() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
  ...
  public void testSearchWithInClause() throws DocumentAlreadyExistsException, DocumentationCreationException, FolderAlreadyExistsException {
    Folder folder = manager.createFolder("theProcessDefUUID");
    Folder subFolder = manager.createFolder("theProcessInstUUID",folder.getId());
    Document doc1 = manager.createDocument("theDoc1", subFolder.getId(), "testFile.txt", "plain/text",
        "The doc contents1".getBytes());
...
//  }
  ...
  public void testSearchOnAllVersion() throws FolderAlreadyExistsException, DocumentationCreationException, DocumentAlreadyExistsException, InterruptedException{
    Folder folder = manager.createFolder("allVersion");
    Document document = manager.createDocument("theDoc1", folder.getId(), "testFile.txt", "plain/text","The doc contents11".getBytes());
    Document lastVersion = manager.createVersion(document.getId(), true);
  ...
  public void testUploadBigFile() throws DocumentAlreadyExistsException, DocumentationCreationException, InterruptedException, IOException, DocumentNotFoundException{
    ...
    Document document = manager.createDocument("myDocument", definitionUUID, new ProcessInstanceUUID(definitionUUID, 1),"Order_Process--1.0 (1).bar","octet/stream",byteArray);
    assertNotNull(document);
  ...
  public void testDeleteOnlyOneVersion() throws DocumentAlreadyExistsException, DocumentationCreationException, InterruptedException, IOException, DocumentNotFoundException{
    byte[] contents = "The doc contents".getBytes();
    String fileName = "testFile.txt";
    String docName = "theDoc";
    String contentMimeType = "plain/text";
    long contentSize = contents.length;
    Document doc = manager.createDocument(docName, new ProcessDefinitionUUID("c"), new ProcessInstanceUUID("d"), fileName, contentMimeType, "The doc contents".getBytes());
